해당 레포지토리는 openai api를 사용하며, 아래 조건을 바탕으로 작성하였습니다.
...
<b>기술 스택:</b>
프론트엔드: Next.js 를 사용하여 사용자 인터페이스를 구현합니다.
백엔드: Django를 사용하여 서버를 구축하고, 데이터베이스를 연결합니다.
데이터베이스: Asynchronous 데이터베이스 MySQL를 사용하여 문서를 저장합니다.
AI 모델: ChatGPT 와 같은 LLM 오픈 소스 API를 활용하여 문법 첨삭 기능을 구현합니다.
...
참고자료는 해당 링크([노션 링크](https://nlogn.notion.site/Ai-Grammar-Checker-11556075d14180a0ba28c0250a0b0220?pvs=4))에 작성하였습니다.
